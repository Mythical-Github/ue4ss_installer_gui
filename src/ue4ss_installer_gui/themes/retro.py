...
def create_theme():
    with dpg.theme() as theme:
        with dpg.theme_component(dpg.mvAll):
            # Base Backgrounds
            dpg.add_theme_color(dpg.mvThemeCol_WindowBg, (15, 5, 30, 255))  # Dark purple-blue
            ...
            dpg.add_theme_color(dpg.mvThemeCol_HeaderHovered, (255, 105, 180, 255))  # Hot Pink
            dpg.add_theme_color(dpg.mvThemeCol_HeaderActive, (0, 200, 255, 255))  # Jaguar Blue

            # Buttons
            dpg.add_theme_color(dpg.mvThemeCol_Button, (55, 0, 85, 255))  # Purple
            dpg.add_theme_color(dpg.mvThemeCol_ButtonHovered, (138, 43, 226, 255))  # Bright Violet
            dpg.add_theme_color(dpg.mvThemeCol_ButtonActive, (0, 255, 180, 255))  # Cyan Green
            ...
            dpg.add_theme_color(dpg.mvThemeCol_ScrollbarGrabHovered, (255, 105, 180, 255))
            ...
            dpg.add_theme_color(dpg.mvThemeCol_NavWindowingHighlight, (0, 255, 127, 255))
