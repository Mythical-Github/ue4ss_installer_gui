...
def create_theme():
    with dpg.theme() as theme:
        ...
        with dpg.theme_component(dpg.mvAll):
            # Text
            dpg.add_theme_color(
                dpg.mvThemeCol_Text, (192, 202, 245, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
            ...
            # Window
            dpg.add_theme_color(
                dpg.mvThemeCol_WindowBg, (36, 40, 59, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
                dpg.mvThemeCol_ChildBg, (41, 46, 66, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
                dpg.mvThemeCol_PopupBg, (41, 46, 66, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
            ...
            dpg.add_theme_color(
                dpg.mvThemeCol_Header, (86, 95, 137, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
            ...
            # Buttons
            dpg.add_theme_color(
                dpg.mvThemeCol_Button, (59, 66, 97, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
            ...
            dpg.add_theme_color(
                dpg.mvThemeCol_FrameBg, (59, 66, 97, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
            ...
            # Tabs
            dpg.add_theme_color(
                dpg.mvThemeCol_Tab, (59, 66, 97, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
            ...
            # Title and menubar
            dpg.add_theme_color(
                dpg.mvThemeCol_TitleBg, (41, 46, 66, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
            ...
            # Borders and shadows
            dpg.add_theme_color(
                dpg.mvThemeCol_Border, (86, 95, 137, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
