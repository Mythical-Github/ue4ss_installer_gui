...
def create_theme():
    with dpg.theme() as theme:
        with dpg.theme_component(dpg.mvAll):
            # Text
            dpg.add_theme_color(
                dpg.mvThemeCol_Text, (170, 180, 220, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
            ...
            dpg.add_theme_color(
                dpg.mvThemeCol_WindowBg, (22, 25, 40, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
                dpg.mvThemeCol_ChildBg, (28, 31, 50, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
                dpg.mvThemeCol_PopupBg, (28, 31, 50, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
            ...
            # Headers
            dpg.add_theme_color(
                dpg.mvThemeCol_Header, (55, 60, 90, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
            ...
            # Buttons
            dpg.add_theme_color(
                dpg.mvThemeCol_Button, (40, 45, 70, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
            ...
            dpg.add_theme_color(
                dpg.mvThemeCol_FrameBg, (40, 45, 70, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
            ...
            # Tabs
            dpg.add_theme_color(
                dpg.mvThemeCol_Tab, (40, 45, 70, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
            ...
            dpg.add_theme_color(
                dpg.mvThemeCol_TitleBg, (28, 31, 50, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
            ...
            # Borders
            dpg.add_theme_color(
                dpg.mvThemeCol_Border, (55, 60, 90, 255), category=dpg.mvThemeCat_Core
            )
            dpg.add_theme_color(
